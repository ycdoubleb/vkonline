    ...
    <div class="col-lg-12 col-md-12">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="btn-group" role="group">
                    <?php
                        ...
                        echo Html::a(Yii::t('app', 'Document'), ['document/index', 'user_cat_id' => ArrayHelper::getValue($filters, 'user_cat_id')], ['class' => 'btn btn-default material-btn active']);
        ...
        <div class="btngroup material-operation">
            <?php
                ...
                ]), ['/build_course/document-import', 'user_cat_id' => $user_cat_id], ['class' => 'btn btn-success btn-flat', 'target' => '_blank']);
            ?>
        </div>
