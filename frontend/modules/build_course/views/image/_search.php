            ...
            <div class="col-lg-4 col-md-4">
                <div class="btn-group" role="group">
                    <?php
                        ...
                        echo Html::a(Yii::t('app', 'Audio'), ['audio/index'], ['class' => 'btn btn-default material-btn']);
                        echo Html::a(Yii::t('app', 'Document'), ['document/index'], ['class' => 'btn btn-default material-btn']);
                        echo Html::a(Yii::t('app', 'Image'), ['image/index'], ['class' => 'btn btn-default material-btn active']);
                    ?>
                </div>
            </div>
        </div>
