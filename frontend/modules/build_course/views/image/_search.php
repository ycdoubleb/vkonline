...
<div class="image-search vk-form clear-shadow vk-material"> 
    ...
    <div class="col-lg-12 col-md-12">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="btn-group" role="group">
                    <?php
                        ...
                        echo Html::a(Yii::t('app', 'Image'), ['image/index', 'user_cat_id' => ArrayHelper::getValue($filters, 'user_cat_id')], ['class' => 'btn btn-default material-btn active']);
                    ?>
                </div>
            </div>
        </div>
        ...
        <div class="btngroup material-operation">
            <?php
                ...
                ]), ['/build_course/image-import', 'user_cat_id' => $user_cat_id], ['class' => 'btn btn-success btn-flat', 'target' => '_blank']);
            ?>
        </div>
