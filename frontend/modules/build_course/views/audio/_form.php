...
<div class="audio-form vk-form set-bottom">
    ...
    ])->label(Yii::t('app', '{Audio}{Des}', [
        'Audio' => Yii::t('app', 'Audio'), 'Des' => Yii::t('app', 'Des')
    ])) ?>

    <!--音频文件-->
    <div class="form-group field-audiofile-file_id">
        <?= Html::label(Yii::t('app', '{Audio}{File}', [
            'Audio' => Yii::t('app', 'Audio'), 'File' => Yii::t('app', 'File')
...
$js = <<<JS
    ...
    */
     ...
     */
    function isExist(){
        var len = $('#uploader-container input[name="'+ 'AudioFile[file_id][]'+'"]').length;
        if(len <= 0){
            return false;
        }else{
            return true;
