...
<li id="{%id%}">
    <div class="head gray">
        ...
        <div class="icongroup">
            <a href="view-video?id={%id%}" target="_blank"><i class="fa fa-eye"></i></a>
            <a href="edit-video?id={%id%}" onclick="showModal($(this));return false;"><i class="fa fa-pencil"></i></a>
            <a href="del-video?id={%id%}" onclick="showModal($(this));return false;"><i class="fa fa-times"></i></a>
