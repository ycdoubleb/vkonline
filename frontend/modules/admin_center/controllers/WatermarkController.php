...
class WatermarkController extends BaseController
{
    ...
    /**
     * Lists all CustomerWatermark models.
     * @return mixed
     */
    ...
    /**
     * Displays a single CustomerWatermark model.
     * @param string $id
     * @return mixed
    ...
    /**
     * Creates a new CustomerWatermark model.
    ...
    /**
     * Updates an existing CustomerWatermark model.
    ...
    /**
     * Deletes an existing CustomerWatermark model.
    ...
    /**
     * Finds the CustomerWatermark model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return CustomerWatermark the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
