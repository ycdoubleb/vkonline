...
<div class="res_service-index main">
    ...
    <div class="panel">
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                [
                    'label' => Yii::t('app', 'Number Of Course Brands'),
                    'value' => 4,
                ],
                [
                    'label' => Yii::t('app', 'Number Of Application  Course'),
                    'value' => 230,
                ],
                [
                ...
                [
                    'format' => 'raw',
                    'label' => Yii::t('app', 'Course Visits'), 'value' => 245454,
                ],
                [
                    'label' => Yii::t('app', 'Number Of Application  Video'),
                    'format' => 'raw',
                    'value' => 230,
                ],
                [
