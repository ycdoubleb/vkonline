...
class CheckFileAction extends Action {
    ...
    public function run() {
        ...
        if ($dbFile) {
            return UploadResponse::create(UploadResponse::CODE_FILE_EXIT, null, $dbFile->toArray());
        } else {
            ...
            if ($fileChunks != null && count($fileChunks) > 0) {
                //上传过程中断...
                return UploadResponse::create(UploadResponse::CODE_FILE_INTERRUPT, null, $fileChunks);
            }
        }
        //文件从未上传过
