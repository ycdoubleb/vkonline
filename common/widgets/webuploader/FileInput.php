...
JS;
    ...
    public function renderInput ($model, $attribute)
    {
        ...
        $eles[] = Html::tag('span', Html::button('选择文件', $this->chooseButtonClass), ['class' => 'input-group-btn']);
    ...
    public function renderImage ($model, $attribute)
    {
        ...
        $eles[] = Html::tag('em', 'x', ['class' => 'close delImage', 'title' => '删除这个文件']);
    ...
    public function renderMultiImage ($model, $attribute)
    {
        ...
        if ($srcTmp) {
            ...
            foreach ($srcTmp as $k => $v) {
                ...
                $eles[] = Html::tag('em', 'x', ['class' => 'close delMultiImage', 'title' => '删除这个文件']);
