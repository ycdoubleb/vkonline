...
class SearchAction extends BaseAction {
    ...
    private function getCategoryChildrenQuery($user_cat_id, $user, $customer_id, $type, $recursive) {
        ...
        $querys = [];
        /* 视频 */
        $querys[1] = $this->createFileQuery(Video::tableName(), $user_cat_id, $user, $customer_id, $recursive)
        ...
        /* 音频 */
        $querys[2] = $this->createFileQuery(Audio::tableName(), $user_cat_id, $user, $customer_id, $recursive)
        ...
        /* 图片 */
        $querys[3] = $this->createFileQuery(Image::tableName(), $user_cat_id, $user, $customer_id, $recursive)
        ...
        /* 文档 */
        $querys[4] = $this->createFileQuery(Document::tableName(), $user_cat_id, $user, $customer_id, $recursive)
