...
class TestController extends Controller {
     ...
     * 写一个简单表格
     */
    public function actionWriteSimple() {
...
// Set cell number formats
        ...
        $spreadsheet->getActiveSheet()->getStyle('E4:E13')->getNumberFormat()->setFormatCode(NumberFormat::FORMAT_CURRENCY_USD_SIMPLE);
...
// Add a drawing to the worksheet
        ...
        $drawing->setPath($path . '/images/officelogo.jpg');
...
// Add a drawing to the worksheet
        ...
        $drawing->setPath($path . '/images/paid.png');
...
// Add a drawing to the worksheet
        ...
        $drawing->setPath($path . '/images/PhpSpreadsheet_logo.png');
        $drawing->setHeight(36);
...
// Add a drawing to the worksheet
        ...
        $drawing->setPath($path . '/images/termsconditions.jpg');
...
// Set active sheet index to the first sheet, so Excel opens this as the first sheet
        ...
        //$writer->save("D:/backup/Desktop/test/01writesimple.xlsx");
    ...
    public function actionTest() {
        ...
        // Save
        $writer = IOFactory::createWriter($spreadsheet, 'Xlsx');
        $writer->save("D:/backup/Desktop/test/08_Conditional_formatting.xlsx");
    }

    /**
     * 读富文件
     */
    public function actionReadRichFile() {
        $path = Yii::getAlias('@vendor/phpoffice/phpspreadsheet/samples');
        $reader = IOFactory::createReader('Xls');
        $spreadsheet = $reader->load("$path/templates/30template.xls");
    }
