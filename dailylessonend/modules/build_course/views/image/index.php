...
<div class="image-index vk-material main">
    ...
    <div class="vk-tabs">
        <ul class="list-unstyled pull-left">
            <li>
                <span class="summary">共 <b><?= $totalCount ?></b> 个图像素材</span>
            </li>
        </ul>
        <ul class="list-unstyled pull-right hidden">
            ...
            <li>
                <span style="padding: 0px 5px; line-height: 54px;">
                    <?= Html::a(Yii::t('app', 'Confirm'), ['arrange/move', 'table_name' => 'image'], [
...
$list_dom = json_encode(str_replace(array("\r\n", "\r", "\n"), " ", 
    $this->renderFile('@dailylessonend/modules/build_course/views/image/____list_dom.php')));
$js = <<<JS
    ...
    $(window).scroll(function(){
        if($(document).scrollTop() >= $(document).height() - $(window).height() - 300){
            loaddata(page, "/build_course/image/index");
        }
    });
    //加载第一页的课程数据
    loaddata(page, "/build_course/image/index");
